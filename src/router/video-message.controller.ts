...
import SaveVideoController from "../modules/save-files/save-video.controller";
import * as CommandsUtils from "../utils/commands-utils";
import {EFolders} from "../shared/folders.enum";

export default class VideoMessageController {
  ...
  public static replyVideo(ctx: Context) {
    ...
    if (commands.save)
      return new SaveVideoController(ctx).saveRepliedVideo();
